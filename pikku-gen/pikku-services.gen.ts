...
// Type exports
export type RequiredSingletonServices = Pick<SingletonServices, 'config' | 'eventHub' | 'logger' | 'schema' | 'secrets' | 'variables'> & Partial<Omit<SingletonServices, 'config' | 'eventHub' | 'logger' | 'schema' | 'secrets' | 'variables'>>
