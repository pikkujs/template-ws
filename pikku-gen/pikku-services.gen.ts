...
// Type exports
export type RequiredSingletonServices = Pick<SingletonServices, 'config' | 'eventHub' | 'jwt' | 'logger' | 'schema' | 'secrets' | 'variables'> & Partial<Omit<SingletonServices, 'config' | 'eventHub' | 'jwt' | 'logger' | 'schema' | 'secrets' | 'variables'>>
